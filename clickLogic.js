...
showAll = function(){
	...
	{
		allUrls.push("<a href='javascript:imageClick(" + catalog[current_item_number]['style_id'] + ")'><img id = '" + catalog[current_item_number]['style_id'] + "' class = large_display src='http://g.nordstromimage.com/imagegallery/store/product/large/" + catalog[current_item_number]['image_url'] + ".jpg' alt='" + catalog[current_item_number]['name'] + "'></a>" );
	};
...
imageClick = function(style_id){
	...
	$(style_id).parent().siblings().children().hide();
